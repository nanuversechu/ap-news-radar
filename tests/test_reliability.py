...
en=[{"title":"Naidu opens Bhogapuram terminal","published":now},{"title":"Vizag rains","published":now},{"title":"Third en","published":now}]
te=[{"title":"భోగాపురం టెర్మినల్ ప్రారంభం","published":now},{"title":"Vizag rains","published":now}]
merged=collect.merge_section([en,te])
check([m["title"] for m in merged]==["Naidu opens Bhogapuram terminal","భోగాపురం టెర్మినల్ ప్రారంభం","Vizag rains","Third en"],
